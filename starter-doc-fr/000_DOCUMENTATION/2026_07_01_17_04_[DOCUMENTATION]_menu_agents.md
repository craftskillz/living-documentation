...
![Menu Agents listant les agents disponibles par provider LLM](/images/DOCUMENTATION/execution_d_agents.png)
...
![Popup demandant l'input nécessaire avant d'exécuter un agent](/images/DOCUMENTATION/popup_execution_agent.png)
...
![Toast affichant la progression temps réel d'une exécution agent](/images/DOCUMENTATION/feedback_execution_agent.png)
...
![Toast de succès contenant le lien vers le document généré par l'agent](/images/DOCUMENTATION/summary_agent_execution.png)
...
![Document de run créé après l'exécution d'un agent](/images/DOCUMENTATION/run_agent_execution.jpg)
