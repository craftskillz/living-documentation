...
<!-- image-width: 2/3 -->
![Exemple de diagramme de contexte Living Documentation](/images/DOCUMENTATION/living_documentation_context_demo_conf.png)
...
```markdown
[![Diagramme de contexte](/images/DOCUMENTATION/mon-diagramme.png)](/diagram?id=diagram-id)
```
