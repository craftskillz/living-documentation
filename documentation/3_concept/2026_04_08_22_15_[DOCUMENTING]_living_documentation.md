...
S'il s'appuie sur le Domain-Driven Design pour que le code _soit_ lui-même de la documentation, il pose une question plus large : comment faire en sorte que la documentation reste vivante, fiable, et qu'elle coûte le moins possible à maintenir ?
