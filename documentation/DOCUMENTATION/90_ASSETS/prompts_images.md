...
Ces prompts servent a generer les images conceptuelles de la documentation utilisateur. Ils sont volontairement en anglais pour maximiser la qualite du rendu.

## Regles d'utilisation

- Utiliser les images generees pour les concepts, pas pour simuler l'interface.
- Utiliser de vraies captures d'ecran pour les guides UI.
- Demander un rendu 16:9 pour les ouvertures de chapitre.
- Refuser les variantes qui contiennent du texte illisible, des logos tiers ou de fausses interfaces trop precises.
- Conserver le prompt exact avec l'image retenue pour pouvoir la regenerer.
...
## Prompt 2 - Documentation obsolete et connaissance fragmentee
...
## Prompt 3 - Architecture local-first
...
## Prompt 4 - Workflow MCP et agents
...
## Prompt 5 - Cycle de vie d'un ADR
...
## Prompt 6 - Fiabilite documentaire et metadonnees
...
## Prompt 7 - Workspace providers et agents
...
## Prompt 8 - Versions Git et restauration de bloc
...
## Prompt 9 - Modeles d'organisation documentaire
...
## Prompt 10 - Du travail brut a la documentation vivante
...
## Prompt 11 - Notes de reunion et processus
...
## Prompt 12 - Laboratoire d'automatisation agentique
