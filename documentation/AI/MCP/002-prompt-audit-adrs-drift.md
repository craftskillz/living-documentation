...
If the result is empty, tell the user _"All ADRs are above the 80% reliability threshold , nothing to audit."_ and stop.
...
Tell the user: _"`<title>` , accuracy was X%, but the description still holds. Re-baselined."_
