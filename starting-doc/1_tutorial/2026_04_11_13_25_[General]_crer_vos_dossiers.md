...
1. Dans un nouveau projet, vous pouvez créer des dossiers avec le bouton `+` en haut, dans le Menu latéral de gauche. Vous devez **obligatoirement créer un document** dans un **nouveau dossier**<br/>
   `Shift+CLIC pour agrandir l'image`
   [![Créer Vos Dossiers (Tutoriel)](./images/cr_er_vos_dossiers_tutoriel.png)](/diagram?id=d1775917727566)

2. Créer un second dossier **2_GUIDE** puis **3_CONCEPT** et enfin **4_REFERENCE**<br/>
Mettez un document dans chacun d'eux pour pouvoir les créer (utiliser un document vide)<br/>
